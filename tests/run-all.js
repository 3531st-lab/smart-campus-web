...
execFileSync(process.execPath, ["--test", path.join(__dirname, "quality-frontend-contract.test.js")], { stdio: "inherit" });
execFileSync(process.execPath, ["--test", path.join(__dirname, "quality-export.test.js")], { stdio: "inherit" });
execFileSync(process.execPath, ["--test", path.join(__dirname, "quality-workflow.test.js")], { stdio: "inherit" });
